...
1. 使用 RimWorld **1.6**。启用 [Harmony](https://steamcommunity.com/sharedfiles/filedetails/?id=2009463077) → [RimTalk](https://steamcommunity.com/sharedfiles/filedetails/?id=3551203752) → [Persona Director](https://steamcommunity.com/sharedfiles/filedetails/?id=3619548407)。也可安装[仓库中的完整模组目录](https://github.com/Rabirinth-hub/RPD/tree/main/Rimtalk-Persona-Director)，保留 `About`、`Assemblies` 和 `Languages`。只有 C# 源码的目录不能直接作为模组加载。
...
1. Use RimWorld **1.6**. Enable [Harmony](https://steamcommunity.com/sharedfiles/filedetails/?id=2009463077) → [RimTalk](https://steamcommunity.com/sharedfiles/filedetails/?id=3551203752) → [Persona Director](https://steamcommunity.com/sharedfiles/filedetails/?id=3619548407). Alternatively install the [complete mod folder](https://github.com/Rabirinth-hub/RPD/tree/main/Rimtalk-Persona-Director) with `About`, `Assemblies`, and `Languages` intact. A folder containing only the C# source is not an installable mod.
